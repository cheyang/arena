...
// re-wraps it as a bare fmt.Errorf without %w (crd.go:72), severing the chain at
// the layer callers use to distinguish "operator not installed" (actionable) from
// a transient/RBAC API error. errors.Is must still see ErrCRDNotFound.
